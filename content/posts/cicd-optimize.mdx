---
title: CI/CD 流程優化案例：縮短 Build 時間與 Image Pull 加速
description: 本文分享如何優化公司內部自建 runner 的 CI/CD 流程，從 image pull rate limit 問題切入，將大型容器鏡像從 GitHub Container Registry 轉移至 GCP GAR，成功將拉取時間從數十分鐘縮短到 3 分鐘，並分析後續 build-script cache 的可能性。
